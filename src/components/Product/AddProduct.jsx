                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="row">
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    <label>Color *</label>
                                                    <input type="text" className="form-control" placeholder="Enter color" data-errors="Please Enter color." name='color' onChange={handleInput} value={formData.color} required />
                                                    <div className="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    <label>Weight *</label>
                                                    <input type="text" className="form-control" placeholder="Enter weight" data-errors="Please Enter weight." name='weight' onChange={handleInput} value={formData.weight} required />
                                                    <div className="help-block with-errors"></div>
                                                </div>
                                            </div>
                                        </div>
